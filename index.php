        ...
        <div class="col-4 text-center mt-lg-5 bg-primary">
          <div class="signup-form  text-white p-5">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <small class="text-mute">By clicking Create Account, you agree to our Terms and confirm that you have read our Data Policy, including our Cookie Use Policy. You may receive SMS message notifications from "InTouch" and can opt out at any time.</small>
                    </div>
                    <div class="form-group">
