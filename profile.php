        ...
        <script>
            $(function(){
                ...
                function CreatePosts(posts)
                {
                    ...
                    {
                        $("#container > div:last-child").after('<div class="row justify-content-center display-5 text-primary border border-info mb-5"><div class="col text-center">NO MORE POSTS</div></div>')
                        $(window).unbind();
                    }
...
<div class="container-fluid" id="container">
    ...
    <div class="row display-5 text-center justify-content-center text-primary border border-info">
        <div class="col">
            <?php
